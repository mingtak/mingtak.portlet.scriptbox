...
from mingtak.portlet.scriptbox import ScriptBoxMessageFactory as _
...
class Assignment(base.Assignment):
    ...
    def __init__(self, scriptTitle=u'', body=u''):
...
class Renderer(base.Renderer):
    ...
    render = ViewPageTemplateFile('scriptbox.pt')

    @property
    def scriptTitle(self):
        return self.data.scriptTitle
...
class AddForm(base.AddForm):
    ...
    """
    form_fields = form.Fields(IScriptBox)
